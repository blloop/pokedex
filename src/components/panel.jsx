export default function Panel({ onClick }) {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none z-30">
      <div
        id="panel-left"
        className="relative top-0 left-0 h-full w-[calc((100vw-100vh)/2)] bg-pokered transition-left duration-500 pointer-events-auto"
      >
      ...
      <div
        id="panel-right"
        className="relative -top-[100vh] -right-[calc(50vw+50vh)] h-full w-[calc((100vw-100vh)/2)] bg-pokered transition-right duration-500 pointer-events-auto"
      >
